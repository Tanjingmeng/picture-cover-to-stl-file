package com.project.tipta.image2litho.stlbean;
...
import com.project.tipta.image2litho.R;
...
public class STLObject {
	...
	private boolean processSTL(byte[] stlBytes, final Context context) {
		...
		final AsyncTask<byte[], Integer, float[]> task = new AsyncTask<byte[], Integer, float[]>() {
			...
			protected void onPostExecute(float[] vertexList) {
				...
				System.out.println("stl normalsize"+vertext_size);
				...
				//adjust center point coordinates
	...
	//move to center point  coordinates
